...
public abstract class BaseInputElement<T> : BaseElement, IInputElement<T>
{
    ...
    /// </summary>
    public abstract Task TypeInput(T input);
    ...
    /// </summary>
    public abstract Task VisibilityTypeInput(T input);
    ...
    public async Task PressKey(KeyCode key) => await Locator.PressAsync(key.ToString());
}
